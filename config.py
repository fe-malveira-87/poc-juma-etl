...
DAYS_FOR_RECENT_REFRESH = 7  # Reprocessamento dos últimos N dias para Transacionais
...
if path_to_sa and os.path.exists(path_to_sa):
    try:
        ...
        raise ValueError(
            f"Erro ao ler o arquivo de credenciais JSON em '{path_to_sa}': {e}"
        )
else:
    # Se a variável não estiver definida ou o arquivo não existir, gera erro explicativo
    if not path_to_sa:
        raise ValueError(
            "A variável de ambiente 'GOOGLE_APPLICATION_CREDENTIALS' não está definida no .env"
        )
    else:
        raise FileNotFoundError(
            f"Arquivo de credenciais não encontrado no caminho: {path_to_sa}"
        )
...
# ====================================================
SERVICE_MAP = {
    # Cadastrais (FULL LOAD - Sem range)
    "CAD_LOJAS": {
        "api_name": "cad_lojas",
        "filter_field": None,
        "load_mode": "WRITE_TRUNCATE",
        "range_type": None,
    },
    "CAD_PESSOAS": {
        "api_name": "cad_pessoas",
        "filter_field": None,
        "load_mode": "WRITE_TRUNCATE",
        "range_type": None,
    },
    "CAD_PRODUTOS": {
        "api_name": "cad_produtos",
        "filter_field": None,
        "load_mode": "WRITE_TRUNCATE",
        "range_type": None,
    },
    "PRODUTOS_SALDO_ESTOQUE_EMPRESA": {
        "api_name": "produtos_saldo_estoque_empresa",
        "filter_field": None,
        "load_mode": "WRITE_TRUNCATE",
        "range_type": None,
    },
    ...
    "DOCUMENTOS_FISCAIS_ENTRADA": {
        "api_name": "documentos_fiscais_entrada",
        "filter_field": "dtmovimento",
        "load_mode": "WRITE_APPEND",
        "range_type": "monthly",
    },
    "ITENS_DOCUMENTOS_FISCAIS_ENTRADA": {
        "api_name": "itens_documentos_fiscais_entrada",
        "filter_field": "dtmovimento",
        "load_mode": "WRITE_APPEND",
        "range_type": "monthly",
    },
    "PAGAMENTOS_DOCUMENTOS_FISCAIS_ENTRADA": {
        "api_name": "pagamentos_documentos_fiscais_entrada",
        "filter_field": "dtmovimento",
        "load_mode": "WRITE_APPEND",
        "range_type": "monthly",
    },
    ...
    "DOCUMENTOS_FISCAIS_SAIDA": {
        "api_name": "documentos_fiscais_saida",
        "filter_field": "dtmovimento",
        "load_mode": "WRITE_APPEND",
        "range_type": "daily",
    },
    "ITENS_DOCUMENTOS_FISCAIS_SAIDA": {
        "api_name": "itens_documentos_fiscais_saida",
        "filter_field": "dtmovimento",
        "load_mode": "WRITE_APPEND",
        "range_type": "daily",
    },
    "RECEBIMENTOS_DOCUMENTOS_FISCAIS_SAIDA": {
        "api_name": "recebimentos_documentos_fiscais_saida",
        "filter_field": "dtmovimento",
        "load_mode": "WRITE_APPEND",
        "range_type": "daily",
    },
...
def get_custom_day_ranges(
    start_date: datetime, end_date: datetime, days_in_batch: int = 10
) -> list[tuple[datetime, datetime]]:
    """
